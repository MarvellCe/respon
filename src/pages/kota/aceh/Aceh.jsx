...
const Aceh = () => {
  ...
  return (
    <div className="divlolo overflow-hidden absolute w-full h-screen font-custom max-sm:scale-50">
      ...
      />
      <div
        className="divkota  min-h-screen w-full bg-cover"
        
      >
        <div className="relative grid place-items-start ms-10 max-sm:scale-75 max-sm:-ms-16 max-sm:mt-32  ">
        ...
        <div className="flex justify-around p-2 max-sm:scale-150 max-sm:-ms-96 ">
