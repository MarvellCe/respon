...
const handleSubmit = () => {
  ...
  return (
    <div className='divlogin fixed w-full h-screen max-sm:grid max-sm:place-items-center font-custom'>
      <img 
      src={login}
      alt='Login'
      className='imglogin fixed w-full h-screen max-sm:max-w-screen max-sm:h-screen max-sm:hidden'/>
      <div className='grid place-items-center relative '>
        <div className='text-center '>
          ...
          className='outline-none bg-transparent text-xl text-black text-center max-sm:text-sm'/>
          <br></br>
          <img src={start} 
